                ...
                <form className="md-float-material form-material" action="#" method="POST" onSubmit={handleSubmit}>
                    <div className="auth-box card-signup">
                        <div className="card-block">
                            ...
                            <div className="form-group form-primary">
                                <input type="text" className="form-control" name="email"  placeholder="Email" id="email" value={formData.email} onChange={handleChange}/>
                            ...
                            <p className="text-inverse text-center">Already have an account? <Link to="/signin" data-abc="true">Login</Link></p>
                        </div>
                    </div>
                </form>
            </div>
